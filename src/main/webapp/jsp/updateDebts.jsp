    ...
    <form method="post" class="row" action="/debtManagement">
        ...
        <div class="col">
            ...
            <div class="form-group">
                ...
                <input name="s_cui" value="<c:out value="${param.sCui}" />" type="text" class="form-control form-control-lg" id="inputCUI" placeholder="cui" pattern="\d{6,9}">
            </div>

            <div class="form-group">
                <label for="name">Company Name</label>
                <input name="sCompanyName" value="<c:out value="${param.sName}" />" type="text" class="form-control form-control-lg" id="name" placeholder="service company name">
            </div>
        </div>
